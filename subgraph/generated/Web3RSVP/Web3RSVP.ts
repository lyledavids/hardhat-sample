...
export class ConfirmAllAttendesCall extends ethereum.Call {
  get inputs(): ConfirmAllAttendesCall__Inputs {
    return new ConfirmAllAttendesCall__Inputs(this);
  }

  get outputs(): ConfirmAllAttendesCall__Outputs {
    return new ConfirmAllAttendesCall__Outputs(this);
  }
}

export class ConfirmAllAttendesCall__Inputs {
  _call: ConfirmAllAttendesCall;

  constructor(call: ConfirmAllAttendesCall) {
    this._call = call;
  }
...
export class ConfirmAllAttendesCall__Outputs {
  _call: ConfirmAllAttendesCall;
